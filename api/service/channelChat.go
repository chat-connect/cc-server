...
func (channelChatService *channelChatService) ListChannelChat(channelKey string) (channelChatResult *model.ChannelChats, err error) {
	channelChatResult, err = channelChatService.channelChatRepository.ListByChannelKey(channelKey)
	if err != nil {
		return nil, err
	}
